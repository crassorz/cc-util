...
public class ValueOf {
	...
	public static boolean has(Object obj, Object key) {
		if (obj == null) {
			...
			try {
				obj.getClass().getField(keyString);
				return true;
			} catch (NoSuchFieldException e) {
			}
			try {
				obj.getClass().getMethod(keyString, obj.getClass());
				return true;
	...
	public static Object get(Object obj, Object key) {
		...
		if (obj instanceof Map) {
			...
			if (index < 0) {
				...
				String keyString = (String) key;
				try {
					return obj.getClass().getField(keyString).get(obj);
				} catch (Throwable e) {
				}
				try {
					return obj.getClass().getMethod(keyString, obj.getClass()).invoke(obj);
				} catch (Throwable e) {
				}
				return null;
			} else {
